...
public class TC012_HighestRating extends BaseTest {
    ...
    public void testTopRatedDescendingFlow() {
        ...
        // Initialize Page Object with Duration to satisfy the CommonCode requirement
        ...
        // Extracting details using the refined regex cleaning in the Page Object
        ...
        Assert.assertFalse(busInfo.contains("Could not retrieve"),
                "Failed to extract rating details from the result list.");

        Assert.assertTrue(busInfo.contains("Rating"),
                "Result string does not contain 'Rating' label as expected: " + busInfo);
